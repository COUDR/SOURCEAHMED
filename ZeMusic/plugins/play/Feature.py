...
@app.on_message(
    filters.command(["مميزات","مميزات كودرا"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس كودرا  ميوزك\n
ꔹ━━━━━━ꔹ𝗰𝗼𝘂𝗱𝗿𝗮ꔹ━━━━━━ꔹ

★قايمه مميزات سورس كودرا 
            ...
            [
                [
                    InlineKeyboardButton(
                        "‹ 𝘀𝗼𝘂𝗿𝗰𝗲✘𝗰𝗼𝘂𝗱𝗿𝗮 ›", url=f"https://t.me/HB_SW"),                        
                 ],[
                InlineKeyboardButton(
